...
export const metadata: Metadata = {
  ...
  description:
    'The complete GLP-1 class comparison: semaglutide vs tirzepatide vs retatrutide vs cagrisema. Clinical weight loss data, titration protocols, and dosing guides. Available from Apollo Peptide Sciences.',
};
...
const articleSchema = {
  ...
  url: 'https://peptideprotocols.com/fat-loss',
