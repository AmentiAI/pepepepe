        ...
        <AnimateIn delay={0.1}>
          <section>
            ...
            <div className="prose-dark space-y-4">
              ...
              <p className="text-gray-300 leading-relaxed">
                PeptideProtocols covers four goal categories: healing and recovery, fat loss, performance, and anti-aging. Every compound is sourced through Phiogen and selected for mechanism clarity, documented human use, and protocol specificity.
              </p>
            </div>
          </section>
        </AnimateIn>
