      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12 sm:space-y-20">
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: 'Look for vendors who provide third-party certificates of analysis (CoA) from accredited analytical labs showing HPLC purity ≥98% and mass spectrometry confirmation of the correct molecular weight. Reputable vendors provide this documentation. Avoid vendors who cannot provide CoA on request or who have suspiciously low prices that may indicate compromised quality control.',
              },
              {
        ...
        <section className="bg-gradient-to-br from-brand-500/10 to-transparent border border-brand-500/20 rounded-3xl p-6 sm:p-10 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-xl mx-auto leading-relaxed">
            Browse all 139 research-grade peptides in our catalog, or read our beginner guide to understand protocols, dosing, and reconstitution step-by-step.
          </p>
