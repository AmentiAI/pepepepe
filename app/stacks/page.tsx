...
export const metadata: Metadata = {
  title: 'Peptide Protocol Stacks — Complete Multi-Compound Guides | PeptideProtocols',
  description:
    'Six expert-designed peptide stacks for healing, fat loss, performance, and anti-aging. Each protocol includes synergy rationale, dosing schedules, reconstitution instructions, and Apollo Peptides sourcing.',
};
