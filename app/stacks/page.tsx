...
export const metadata: Metadata = {
  ...
  description:
    'Six expert-designed peptide stacks for healing, fat loss, performance, and anti-aging. Each protocol includes synergy rationale, dosing schedules, reconstitution instructions, and COA-verified sourcing.',
};
